...
namespace Team3.Migrations
{
    ...
    [Migration("20260320182606_AddTutoringDomainTables")]
    partial class AddTutoringDomainTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Team3.Academic.SubjectTranslation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SubjectId", "LanguageId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Team3.Academic.TopicTranslation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Team3.Tutoring.StudentTutorLink", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("StudentUserId", "SubjectId", "IsActive");

                    b.HasIndex("StudentUserId", "TutorUserId", "SubjectId", "IsActive");

                    b.ToTable("StudentTutorLinks", (string)null);
                });

            modelBuilder.Entity("Team3.Tutoring.StudentTutorRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("StudentUserId", "TutorUserId", "SubjectId", "Status");

                    b.ToTable("StudentTutorRequests", (string)null);
                });

            modelBuilder.Entity("Team3.Tutoring.TutorMeetingRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("StudentTutorLinkId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("StudentTutorLinkId", "Status");

                    b.ToTable("TutorMeetingRequests", (string)null);
                });

            modelBuilder.Entity("Team3.Tutoring.TutorMeetingSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("TutorMeetingSessions", (string)null);
                });

            modelBuilder.Entity("Team3.Tutoring.TutorSubjectAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TutorUserId", "SubjectId")
                        .IsUnique();

                    b.ToTable("TutorSubjectAssignments", (string)null);
                });
            ...
            modelBuilder.Entity("Team3.Tutoring.TutorMeetingRequest", b =>
                {
                    b.HasOne("Team3.Tutoring.StudentTutorLink", null)
                        .WithMany()
                        .HasForeignKey("StudentTutorLinkId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Team3.Tutoring.TutorMeetingSession", b =>
                {
                    b.HasOne("Team3.Tutoring.TutorMeetingRequest", null)
                        .WithMany()
