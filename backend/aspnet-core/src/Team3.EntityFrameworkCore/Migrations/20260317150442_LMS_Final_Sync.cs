...
{
    /// <inheritdoc />
    public partial class LMS_Final_Sync : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SubjectTranslations_Subjects_CoreId",
                        column: x => x.CoreId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TopicTranslations_Topics_CoreId",
                        column: x => x.CoreId,
                        principalTable: "Topics",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LessonTranslations_Lessons_CoreId",
                        column: x => x.CoreId,
                        principalTable: "Lessons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LessonTranslations_CoreId",
                table: "LessonTranslations",
                column: "CoreId");

            migrationBuilder.CreateIndex(
                name: "IX_SubjectTranslations_CoreId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TopicTranslations_CoreId",
