...
public abstract class Team3WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static Team3WebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(Team3WebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<Team3DbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<Team3DbContext, Task> action)
    {
        using (var context = IocManager.Resolve<Team3DbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<Team3DbContext, Task<T>> func)
    {
        T result;
